...
const NavigationSidebar: React.FC<NavigationSidebarProps> = ({ goToDashboard, goToHistory, goToAdmin, isAdmin }) => (
    <aside className="lg:col-span-3 space-y-8">
        <div className="p-5 bg-slate-900 rounded-2xl shadow-xl border border-slate-800 space-y-4 sticky top-24">
            ...
            {isAdmin && (
                <button onClick={goToAdmin} className="w-full text-left p-3 rounded-lg text-lg font-medium text-white bg-slate-700 hover:bg-slate-600 transition duration-150 shadow-md flex items-center gap-3 border border-slate-600">
